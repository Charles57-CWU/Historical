...
class getPlotInfo:
    def __init__(self, dataframe, class_count, feature_count, sample_count,
        ...
        if not plot_type:
            ...
            self.class_dict, self.class_color_dict, self.class_index_starts, self.class_vertex_count = pcp_info.getDatasetVertices()
            ...
            self.marker_dict, self.marker_color_dict, self.marker_index_starts, self.marker_vertex_count, self.marker_count = pcp_info.getMarkerVertices(
                self.class_dict)
            ...
            spcp_info = SPCP.getSPCPInfo(dataframe, class_count, feature_count, sample_count,
                                         count_per_class_array)
            self.class_dict, self.class_color_dict, self.class_index_starts, self.class_vertex_count = spcp_info.getClassVertices()
            ...
            self.marker_dict, self.marker_color_dict, self.marker_index_starts, self.marker_vertex_count, self.marker_count = spcp_info.getMarkerVertices(
                self.class_dict)

        elif plot_type == 'DICP':
            dicp_info = DICP.getDICPInfo(dataframe, class_count, feature_count, sample_count,
                                         count_per_class_array)
            self.class_dict, self.class_color_dict, self.class_index_starts, self.class_vertex_count = dicp_info.getClassVertices()
            ...
            self.marker_dict, self.marker_color_dict, self.marker_index_starts, self.marker_vertex_count, self.marker_count = dicp_info.getMarkerVertices(
                self.class_dict)
